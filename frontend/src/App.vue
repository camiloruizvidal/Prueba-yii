					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="https://media-exp1.licdn.com/dms/image/C4E03AQHBZSxJQr8Wjw/profile-displayphoto-shrink_400_400/0?e=1606348800&v=beta&t=asZPS8QnhAwTLZV0dOGVuEyjMruJ6zbTnSw4EOqihB4" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="https://media-exp1.licdn.com/dms/image/C4E03AQHBZSxJQr8Wjw/profile-displayphoto-shrink_400_400/0?e=1606348800&v=beta&t=asZPS8QnhAwTLZV0dOGVuEyjMruJ6zbTnSw4EOqihB4" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Camilo Ruiz Vidal</h4>
			...
			<footer class="footer">
				<div class="container-fluid">
					<div class="copyright ml-auto">
						Camilo Ruiz Vidal <i class="fa fa-heart heart text-danger"></i>
					</div>				
				</div>
			</footer>
		</div>
								...
								<div class="quick-scroll scrollbar-outer">
									<div class="quick-content contact-content">
										...
										<div class="avatar-group">
											<div class="avatar">
												<img src="http://demo.themekita.com/atlantis/livepreview/examples/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="http://demo.themekita.com/atlantis/livepreview/examples/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="http://demo.themekita.com/atlantis/livepreview/examples/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="http://demo.themekita.com/atlantis/livepreview/examples/assets/img/talha.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
